    ...
    try {
        ...
        if (product.image) {
            ...
            try {
                ...
                console.log("Error in deleting image from cloudianry", error);
            }
        }
...
export const getRecommendedProducts = async (req, resp) => {
    try {
...
export const getProductsByCategory = async (req, resp) => {
...
export const toggleFeatureproducts = async (req, resp) => {
    try {
