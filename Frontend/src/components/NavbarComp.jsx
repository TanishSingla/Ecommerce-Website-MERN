            ...
            <div className="container mx-auto px-4 py-3 ">
                <div className='flex flex-wrap justify-between items-center'>
                    ...
                    <nav className='flex flex-wrap items-center gap-4'>
                        <Link to={"/"} className='text-gray-300 hover:text-emerald-400'>Home</Link>
                        {
                            user && (
                                <Link to="/cart" className='relative group'>
                                    ...
                                    <span className='absolute -top-2 -left-2 bg-emerald-500 text-white rounded-full py-0.5 text-xs px-2 transition duration-300 ease-in-out'>
                                        {cart.length}
                                    </span>
                                </Link>
                            )
                        ...
                        {
                            isAdmin && (
                                <Link to="/admin-dashboard" className='bg-emerald-700 hover:bg-emerald-600 text-white px-3 py-1 rounded-md font-medium transition duration-300 ease-in-out flex items-center'><Lock className='inline-block mr-1' size={18} />
